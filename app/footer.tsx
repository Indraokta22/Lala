    ...
    <main>
      <div className={styles.footerContainer}>
        <div className={styles.icon}>
          ...
          <a
            href="https://www.instagram.com/kopionjogja?igsh=MWdzMmpkeDJxNG51cQ=="
            id={styles.instagram}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            href="https://www.tiktok.com/@kopionjogja?_t=8pwONckHQDY&_r=1"
            id={styles.tiktok}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            href="https://www.google.com/maps/embed?...{URL}"
            id={styles.maps}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="text-white py-10" >
          <p className="text-center">
            Copyright &copy;2024; Designed by<span className="designer">Sikomay</span>
          </p>
        </div>
      </div>
    </main>
